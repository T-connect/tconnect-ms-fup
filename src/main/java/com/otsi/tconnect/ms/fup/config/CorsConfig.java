...
/*
 * package com.otsi.tconnect.ms.revenuemanagement.config;
 * 
 ...
 * "x-requested-with, authorization, Content-Type, Content-Length, Authorization, credential, X-XSRF-TOKEN,keepalive-time,keepalive,storeId,clientId"
 * ; private static final String ALLOWED_METHODS =
 * "GET, PUT, POST, DELETE, OPTIONS, PATCH"; private static final String
 * ALLOWED_ORIGIN = "*"; private static final String MAX_AGE = "7200";
 * 
 ...
 * config.addAllowedOrigin(ALLOWED_ORIGIN); // Angular app's URL
 * config.addAllowedHeader(ALLOWED_HEADERS);
 * config.addAllowedMethod(ALLOWED_METHODS); //config.setMaxAge(null);
